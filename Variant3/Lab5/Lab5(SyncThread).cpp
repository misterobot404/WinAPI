...
LRESULT CALLBACK WindowProcedure(HWND hWnd,		// дескриптор окошка
	UINT message,	// сообщение, посылаемое ќ—
	...
	LPARAM lParam)	// сообщений, дл€ последующего обращени€
{
	...
	switch (message)
	{
		// —ообщение WM_COMMAND посылаетс€ когда:
		// - производитс€ выбор пункта меню
		// - элемент управлени€ посылает уведомительное сообщение родительскому окну
		// - происходит нажатие клавиши акселератора.
	case WM_COMMAND:
	{
		// Wparam - определ€ет источник сообщени€: элемент управлени€ или акселератор.
